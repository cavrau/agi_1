...
async function leAutores (token: Token) {
  let resposta = await executaGET('/qryLeiaUsuarios', { token })
  if (resposta.ok) { return resposta.autores }
  throw new Error('token inválido ou expirado')
}
...
export { fazLogin, leAutores, fazCadastro, publicaLembrete, leLembretes, apagaLembrete }
